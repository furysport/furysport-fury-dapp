...
import { useFuryaSocialFeedCreatePostMutation } from "../../contracts-clients/furya-social-feed/FuryaSocialFeed.react-query";
...
export const useCreatePost = ({
  ...
  const request = useFuryaSocialFeedCreatePostMutation({
    onMutate: (data) => {
