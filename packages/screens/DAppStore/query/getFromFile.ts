...
import furyapunks from "../../../../assets/logos/toniPunks.png";
    ...
    "furya-core-apps": {
      ...
      options: {
        ...
        namespace: {
          id: "namespace",
          title: "Name Service",
          description: "Furya Name Service",
          icon: tnsService,
          route: "TNSHome",
          groupKey: "furya-core-apps",
          selectedByDefault: true,
