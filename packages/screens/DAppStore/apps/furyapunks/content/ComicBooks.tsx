    ...
    <>
      ...
      >
        ...
        <Label
          ...
          style={{ textAlign: "center", color: "#E8E1EF" }}
        >
          Holders of 1 furyapunk + 5 different comic books
        </Label>
        <View
          style={{
            alignContent: "center",
        ...
        >
          <ButtonLabel
            ...
            onPress={() => {
              Linking.openURL(
                "/collection/furya-furya1syx6q5rxhntng93pmk9xep25638dqy3dcnppvvytnccxrp7urt7svgvs8p"
              );
            }}
          />
          <BuyFuryapunksButton size="S" />
